...
<p>Guarda un producto nuevo en la base de datos.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nombre del producto. Example: <code>Mouse RGB</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value="Mouse con luces RGB"
               data-component="body">
    <br>
<p>Descripción del producto. Example: <code>Mouse con luces RGB</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Precio del producto. Example: <code>29.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Stock disponible. Example: <code>10</code></p>
        </div>
        </form>
